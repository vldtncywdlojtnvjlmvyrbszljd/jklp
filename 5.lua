...
spawn(function()
   ...
   M:AddSeperator("Farm Level Mastery")
    ...
    spawn(function()
		while wait() do
			if _G.AutoFarmGunMastery and UseSkillGun == true then
